        ...
        <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #EEF0F3', padding: '32px', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
          {sent ? (
            <div style={{ textAlign: 'center' }}>
              ...
              <div style={{ fontSize: 17, fontWeight: 700, color: '#0A3D26', marginBottom: 10 }}>Email envoye</div>
              <div style={{ fontSize: 13, color: '#64748B', lineHeight: 1.6, marginBottom: 20 }}>
                Un lien de reinitialisation a ete envoye a <strong>{email}</strong>.<br/>
                Votre mot de passe actuel a ete desactive.<br/>
                Verifiez votre boite mail et cliquez sur le lien pour definir un nouveau mot de passe.
              </div>
              <div style={{ padding: '10px 14px', borderRadius: 8, background: '#FEF3C7', border: '1px solid #FCD34D', fontSize: 12, color: '#92400E', marginBottom: 20 }}>
                Le lien est valable 1 heure. Apres ce delai, vous devrez faire une nouvelle demande.
              </div>
              <a href="/login" style={{ display: 'block', textAlign: 'center', fontSize: 13, color: '#0A3D26', fontWeight: 600, textDecoration: 'none' }}>
                Retour a la connexion
              </a>
            </div>
          ) : (
            <>
              <div style={{ fontSize: 18, fontWeight: 700, color: '#1A202C', marginBottom: 6 }}>Mot de passe oublie</div>
              <div style={{ fontSize: 13, color: '#94A3B8', marginBottom: 24, lineHeight: 1.6 }}>
                Saisissez votre email. Vous recevrez un lien pour creer un nouveau mot de passe.<br/>
                Votre mot de passe actuel sera desactive immediatement.
              </div>
              ...
              <div style={{ textAlign: 'center', marginTop: 20, fontSize: 13, color: '#94A3B8' }}>
                <a href="/login" style={{ color: '#0A3D26', fontWeight: 600, textDecoration: 'none' }}>Retour a la connexion</a>
              </div>
            </>
          )}
        </div>
