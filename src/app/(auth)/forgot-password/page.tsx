        ...
        <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #EEF0F3', padding: '32px', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
          {sent ? (
            <div style={{ textAlign: 'center' }}>
              ...
              <div style={{ fontSize: 17, fontWeight: 700, color: '#0A3D26', marginBottom: 10 }}>Email envoyé</div>
              ...
              <a href="/login" style={{ display: 'block', textAlign: 'center', fontSize: 13, color: '#0A3D26', fontWeight: 600, textDecoration: 'none' }}>Retour à la connexion</a>
            </div>
          ) : (
            <>
              ...
              <div style={{ textAlign: 'center', marginTop: 20, fontSize: 13, color: '#94A3B8' }}>
                <a href="/login" style={{ color: '#0A3D26', fontWeight: 600, textDecoration: 'none' }}>Retour à la connexion</a>
              </div>
            </>
          )}
        </div>
