    ...
    <div style={{ minHeight: '100vh', background: '#f5f3ef', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'DM Sans', sans-serif" }}>
      <div style={{ background: '#fff', borderRadius: 12, border: '1px solid #e8e3d8', padding: '40px 36px', width: 400, boxShadow: '0 8px 32px rgba(0,0,0,0.06)' }}>
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          ...
          <div style={{ fontSize: 13, color: '#8b7355', marginTop: 4 }}>Choisissez un mot de passe securise</div>
        </div>
        <div style={{ marginBottom: 14 }}>
          <label style={{ fontSize: 12, fontWeight: 600, color: '#4a5568', display: 'block', marginBottom: 6 }}>Nouveau mot de passe</label>
          <input type='password' value={password} onChange={e => setPassword(e.target.value)} placeholder='Minimum 8 caracteres' style={{ width: '100%', padding: '10px 12px', borderRadius: 8, border: '1.5px solid #d4c5b0', fontSize: 13, boxSizing: 'border-box', outline: 'none', color: '#1a1a1a' }} />
        </div>
        <div style={{ marginBottom: 20 }}>
          <label style={{ fontSize: 12, fontWeight: 600, color: '#4a5568', display: 'block', marginBottom: 6 }}>Confirmer le mot de passe</label>
          <input type='password' value={confirm} onChange={e => setConfirm(e.target.value)} placeholder='Repetez le mot de passe' style={{ width: '100%', padding: '10px 12px', borderRadius: 8, border: '1.5px solid #d4c5b0', fontSize: 13, boxSizing: 'border-box', outline: 'none', color: '#1a1a1a' }} />
        </div>
