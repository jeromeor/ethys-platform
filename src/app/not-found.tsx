  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f5f3ef', fontFamily: "'DM Sans', sans-serif" }}>
      <div style={{ textAlign: 'center', maxWidth: 480, padding: '40px 24px' }}>
        <img src="/logo_ethys.png" alt="TEXTILE LOOP" style={{ width: 120, height: 'auto', margin: '0 auto 32px', display: 'block' }} />
        <div style={{ fontSize: 80, fontWeight: 900, color: '#1a1a1a', lineHeight: 1, marginBottom: 16 }}>404</div>
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center' }}>
          <a href="/dashboard" style={{ padding: '10px 24px', borderRadius: 10, background: '#1a1a1a', color: '#fff', fontSize: 13, fontWeight: 700, textDecoration: 'none' }}>
            Retour au dashboard
          </a>
