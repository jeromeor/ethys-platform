...
export default function SidebarLayout({ user, profil, children }: Props) {
  ...
  return (
    <div style={{
      ...
      background: '#F7F8FA', color: '#1A202C', overflow: 'hidden'
    }}>
      {/* Sidebar */}
      <aside style={{
        width: open ? 220 : 64, minWidth: open ? 220 : 64,
        background: '#0A3D26', display: 'flex', flexDirection: 'column',
        ...
        <div style={{ padding: '10px 12px 14px', borderTop: '1px solid rgba(255,255,255,0.08)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
            ...
            {open && <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: 10, color: '#6EE7B7', textTransform: 'capitalize' }}>
          ...
          {open && (
            <button onClick={handleLogout} style={{
              width: '100%', padding: '6px', borderRadius: 8, border: '1px solid rgba(255,255,255,0.15)',
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        {/* Topbar */}
        <header style={{
          height: 60, background: '#fff', borderBottom: '1px solid #EEF0F3',
